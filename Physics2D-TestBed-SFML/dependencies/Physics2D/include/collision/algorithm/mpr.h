...
namespace Physics2D
{
	...
	public:
        ...
        static std::tuple<Vec2, Simplex> discover(const ShapePrimitive& shapeA, const ShapePrimitive& shapeB);
		/// <summary>
		...
		static std::tuple<bool, Simplex> refine(const ShapePrimitive& shapeA, const ShapePrimitive& shapeB,const Simplex& source, const Vec2& centerToOrigin, const real& iteration = 50);
	};
}
#endif
