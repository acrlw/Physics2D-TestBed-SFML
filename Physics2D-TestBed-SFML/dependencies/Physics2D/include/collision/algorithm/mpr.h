...
namespace Physics2D
{
	...
	public:
        ...
        static std::tuple<Vec2, Simplex> discover(const Transform& transformA, Shape* shapeA, const Transform& transformB, Shape* shapeB);
		/// <summary>
		...
		static std::tuple<bool, Simplex> refine(const Transform& transformA, Shape* shapeA, const Transform& transformB, Shape* shapeB,
			const Simplex& source, const Vec2& centerToOrigin, const real& iteration = 50);
	};
}
#endif
